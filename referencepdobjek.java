...
public class referencepdobjek{
    public static void main(String[] args) {
        ...
        // assignment object
        Buku buku2 = buku1;//buku2 akan memiliki reference pd buku1 sehingga buku1 tidak dicpoykan ke buku2 
        buku2.display();
    ...
    public static void fungsi(Buku dataBuku){
        ...
        //di method ini objek dataBuku akan memiliki reference pada buku2 sehingga apapun yang diubah pada dataBuku ini, akan mengubah buku2
